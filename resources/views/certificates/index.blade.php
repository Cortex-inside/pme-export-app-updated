...
@section('header')
    <div class="d-flex">
        ...
        <div class="">
            <a class="btn btn-success " href="{!! route('certificates.export') !!}">Exportar</a>
            <a class="btn btn-primary "  href="{!! route('certificates.create') !!}"><span class="ion ion-md-add"></span>&nbsp; Cadastrar </a>
        </div>
    </div>
