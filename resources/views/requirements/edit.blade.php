...
@section('content')
    <div class="card mb-4">
        ...
        {!! Form::model($requirement, ['route' => ['requirements.update', $requirement->id], 'method' => 'patch']) !!}
            <div class="card-body">
            ...
            <div class="card-footer">
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <a href="{!! route('requirements.index') !!}" class="btn btn-default  pull-right">Cancelar</a>
                    </div>
                </div>
            </div>
        {!! Form::close() !!}
