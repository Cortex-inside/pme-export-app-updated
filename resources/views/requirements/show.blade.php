...
@section('header')
    ...
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" ><a href="{{route("requirements.index")}}">Exigencias</a></li>
        </ol>
    </div>
@endsection
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            @include('requirements.show_fields')
    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="form-group">
                <a href="{!! route('requirements.index') !!}" class="btn btn-default"><span
