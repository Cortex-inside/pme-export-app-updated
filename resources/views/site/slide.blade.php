...
<header id="start-screen" class="start-screen--style-1">
    <div id="vegas-slider" data-dots="true">
        <div class="vegas-control">
            ...
            <span id="vegas-control__next" class="vegas-control__btn">Próximo</span>
        </div>
    </div>
                ...
                <div class="container">
                    <div class="row flex-items-md-center text-center">
                        <div class="col-xs-12 col-lg-10 col-xl-8">
                            <p class="title"> Qualificação PME</p>


                            <p>
                                A Qualificação PME é o conjunto de serviços de apoio ao expositor, fornecidos pelo IPEME, para que estes possam fazer a exportação dos seus produtos.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="v-align">
            <div class="v-middle">
                <div class="container">
                    <div class="row flex-items-md-center text-center">
                        <div class="col-xs-12 col-lg-10 col-xl-8">
                            <p class="title"> Subvenção PME</p>

                            <p>
                                A Subvenção PME é o suporte legal e/ou financeiro oferecido pelo IPEME como forma de possibilitar ao expositor a ter qualificação de exportador e/ou a exportar os seus produtos.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="v-align">
            <div class="v-middle">
                <div class="container">
                    <div class="row flex-items-md-center text-center">
                        <div class="col-xs-12 col-lg-10 col-xl-8">
                            <p class="title">Promoção PME</p>

                            <p>
                                A Promoção PME compreende o conjunto de actividades e recursos usados pelo IPEME para a publicidade e divulgação dos expositores da plataforma PME Exporte.                            </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row flex-items-md-center text-center">
                        <div class="col-xs-12 col-lg-10 col-xl-8">
                            ...
                            <p>
                                Quer exportar e ter apoio para exportar? Quer divulgar o seu produto? Quer fazer parte do Clube das PME's e beneficiar de outros programas de apoio ao seu negocio? Inscreva-te ja no Catalogo PME Exporte</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            jQuery(document).ready(function($){
              ...
              var slider = $('#vegas-slider'),
                slides = [
                  {
                    name: "img 1",
                    src: '../img/home_img/fundo1.jpg'
                  },
                  {
                    name: "img 2",
                    src: '../img/home_img/fundo2.jpg'
                  },
                  {
                    name: "img 3",
                    src: '../img/home_img/fundo3.jpg'
                  },
                  {
                    name: "img 4",
                    src: '../img/home_img/slide4.png'
                  }
                ],
