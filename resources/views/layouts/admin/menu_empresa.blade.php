@include('layouts.admin.partials_menu_empresa')
@if(Auth::user()->company->status != 5 && Auth::user()->company->status != 4 && Auth::user()->company->status != 2)
    <ul class="sidenav-inner py-1">
        ...
        <li class="sidenav-item {{(Route::is("exchange.index"))? "active": ""}}" data-toggle="tooltip"
            data-placement="right" title="@lang('sistema.menu_empresa.CompraVenda')" >
        ...
        <li class="sidenav-item   @if(Request::is('exchange/requests') OR Request::is('exchange/requests-enviados')  OR Request::is('exchange/requests-recebidos')) open @endif">
            <a href="javascript:" class="sidenav-link sidenav-toggle">
        ...
        <li class="sidenav-item  @if(Request::is('sysCompany.company.index') OR Request::is('sysCompany/company') OR
        Request::is('sysCompany/company/companyPartners*') OR Request::is
        ('sysCompany/company/companyRepresentatives*') OR Route::is('sysCompany.company.users.change_password')) open @endif">
            <a href="javascript:" class="sidenav-link sidenav-toggle">
            ...
            <ul class="sidenav-menu">
                ...
                <li class="sidenav-item {{(Request::is('sysCompany/company/companyPartners*'))? "active": ""}}" data-toggle="tooltip"
                    data-placement="right" title="@lang('sistema.menu_empresa.Socios')" >
                    <a class="sidenav-link" href="{{route("companyPartners.index")}}"><div><i class=" fas fa-people-carry "></i> @lang('sistema.menu_empresa.Socios')</div></a>
                </li>
                <li class="sidenav-item {{(Request::is('sysCompany/company/companyRepresentatives*'))? "active": ""}}" data-toggle="tooltip"
                    data-placement="right" title="@lang('sistema.menu_empresa.Representantes')" >
                    <a class="sidenav-link" href="{{route("companyRepresentatives.index")}}"><div><i class=" oi oi-people "></i> @lang('sistema.menu_empresa.Representantes')</div></a>
                </li>
