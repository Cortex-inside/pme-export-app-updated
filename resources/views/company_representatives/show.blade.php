...
@section('header')
    <div class="d-flex">
        ...
        <div class="">
            ...
            <a href="{!! route('companyRepresentatives.edit', [$companyRepresentative->id]) !!}" class='btn
...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            @include('company_representatives.show_fields')
    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="form-group">
                <a href="{!! route('companyRepresentatives.index') !!}" class="btn btn-default"><span
