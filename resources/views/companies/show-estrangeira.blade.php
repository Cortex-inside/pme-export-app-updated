    ...
    <div class="d-flex">
        ...
        <div class="">
            ...
            @if($company->status == 1)
                ...
                <a class="btn btn-warning"  data-toggle="modal" data-target="#myModal" role="group"><i class="feather icon-thumbs-down"></i> Reprovar</a>
            @else
...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            @include('companies.show_estrangeira_fields')
    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="form-group">
                <a href="{!! route('certificateCategories.index') !!}" class="btn btn-default"><span
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {!! Form::submit('Reprovar cadastro', ['class' => 'btn btn-danger', 'onClick' => 'if(confirm("Deseja realmente reprovar esse cadastro?")) { return true } else {return false };']) !!}
